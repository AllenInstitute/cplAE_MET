...
class Dec_zme_to_zme_int(nn.Module):
    def __init__(self, in_dim=3, out_dim=20):
        super(Dec_zme_to_zme_int, self).__init__()
        self.fc_0 = nn.Linear(in_dim, 20)
        self.fc_1 = nn.Linear(20, 20)
        self.fc_2 = nn.Linear(20, out_dim)
        self.elu = nn.ELU()
        self.relu = nn.ReLU()
        return
    ...
    def forward(self, zme):
        ...
        xm_int, xe_int = torch.split(x,[10,10], dim = 1)
