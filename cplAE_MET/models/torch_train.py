...
def main(alpha_T=1.0, alpha_E=1.0, alpha_M=1.0, lambda_TE=1.0, lambda_ME=1.0,
         ...
         n_epochs=5000, run_iter=0, model_id='MET', exp_name='MET_torch'):

    #TODO

    # dir_pth = set_paths(exp_name=exp_name)
    dir_pth = {}
    dir_pth['result'] = "/Users/fahimehb/Documents/git-workspace/cplAE_MET/data/results"
    dir_pth['logs'] = "/Users/fahimehb/Documents/git-workspace/cplAE_MET/data/logs"
    ...
    #train_ind, val_ind = get_splits(data=D, fold=0, n_folds=10) #Is it different than sklearn split? what is fold=0
