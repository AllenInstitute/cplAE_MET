...
from cplAE_MET.models.model_classes import Model_ME_T_v1
...
# TODO
parser.add_argument('--exp_name',        default='TEM_8643_103MNPCs_l3_v1',  type=str,   help='Experiment set')
...
parser.add_argument('--lambda_tune_T_E', default=0.5,                         type=float, help='Tune the directionality of coupling between T and E')
parser.add_argument('--lambda_tune_E_T', default=0.5,                         type=float, help='Tune the directionality of coupling between T and E')
parser.add_argument('--lambda_tune_T_M', default=0.5,                         type=float, help='Tune the directionality of coupling between T and M')
parser.add_argument('--lambda_tune_M_T', default=0.5,                         type=float, help='Tune the directionality of coupling between T and M')
parser.add_argument('--lambda_tune_E_M', default=0.5,                         type=float, help='Tune the directionality of coupling between M and E')
parser.add_argument('--lambda_tune_M_E', default=0.5,                         type=float, help='Tune the directionality of coupling between M and E')
parser.add_argument('--lambda_tune_T_ME',default=0.5,                         type=float, help='Tune the directionality of coupling between ME and T')
parser.add_argument('--lambda_tune_ME_T',default=0.5,                         type=float, help='Tune the directionality of coupling between ME and T')
parser.add_argument('--lambda_tune_ME_M',default=0.5,                         type=float, help='Tune the directionality of coupling between ME and M')
parser.add_argument('--lambda_tune_M_ME',default=0.5,                         type=float, help='Tune the directionality of coupling between ME and M')
parser.add_argument('--lambda_tune_ME_E',default=0.5,                         type=float, help='Tune the directionality of coupling between ME and E')
parser.add_argument('--lambda_tune_E_ME',default=0.5,                         type=float, help='Tune the directionality of coupling between ME and E')
...
def main(exp_name="DEBUG",
    ...
    dat = MET_exc_inh_v1.from_file(dir_pth['MET_data'])
    ...
    train_dataset = MET_dataset_v1(train_dat, device=device)
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, drop_last=True)

    val_dataset = MET_dataset_v1(val_dat, device=device)
    val_dataloader = DataLoader(val_dataset, batch_size=len(val_dataset), shuffle=False)

    dataset = MET_dataset_v1(dat, device=device)
    ...
    model = Model_ME_T_v1(model_config)
