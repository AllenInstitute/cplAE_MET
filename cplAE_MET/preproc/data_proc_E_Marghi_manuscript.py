...
parser.add_argument('--config_file',    default='config_preproc_Marghi_manuscript.toml', type=str,    help='config file with data paths')
parser.add_argument('--pca_th',         default=0.97,                                    type=float,  help='threshold for pca explained variance')


def set_paths(config_file=None):
    '''Read the config file and set the input and output path'''
